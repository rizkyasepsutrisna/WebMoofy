                ...
                <div class="sign-user_card ">
                    <div class="sign-in-page-data">
                        <div class="sign-in-from w-100 m-auto">
                            <h3 class="mb-3 text-center">Sign Up Admin</h3>
                            <form class="mt-4" method="POST" action="<?= base_url('auth/signup_admin'); ?>">
                    ...
                    <div class="mt-3">
                        <div class="d-flex justify-content-center links">
                            Already have an account admin? <a href="<?= base_url('auth/signin_admin'); ?>" class="text-primary ml-2">Sign In</a>
                        </div>
                    </div>
                </div>
            </div>
